...
int main(int argc, char** argv)
{
	...
	HOGDescriptor hog(Size(240,240), Size(16, 16), Size(8, 8), Size(8, 8), 9);

	vector<float> descriptor;
	hog.compute(src_gray, descriptor);
	...
	Mat visual = get_hogdescriptor_visu(src, descriptor, Size(250,252));
